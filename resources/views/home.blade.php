    ...
    <section class="hero-section">
        <div class="hero-overlay">
            <div class="container hero-content">
                ...
                <form class="hero-search" action="{{ route('categories') }}" method="get">
                    <input type="text" name="q" placeholder="Search products, stores, or categories">
        ...
        <div class="container">
            ...
            <article class="card feature-panel">
                <div class="feature-grid">
                    ...
                    <div class="icon-wrap">
                        <img src="{{ asset('assets/icons/simple-shopping.png') }}" alt="Simple shopping icon" class="feature-icon-image">
                    </div>
                    ...
                    <article class="feature-card">
                    <div class="icon-wrap">
                        <img src="{{ asset('assets/icons/local-traders.png') }}" alt="Local traders icon" class="feature-icon-image">
                    </div>
                    <h3>Local Traders</h3>
                    ...
                    <article class="feature-card">
                    <div class="icon-wrap">
                        <img src="{{ asset('assets/icons/easy-pickup.png') }}" alt="Easy pickup icon" class="feature-icon-image">
                    </div>
                    <h3>Easy Pickup</h3>
